...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-04-2015 a las 13:26:30
...
CREATE TABLE IF NOT EXISTS `sensoractuador` (
  `Id_Sensores` varchar(20) NOT NULL,
  `PIN` int(11) NOT NULL,
...
INSERT INTO `sensoractuador` (`Id_Sensores`, `PIN`, `TipoValor`, `Valor`, `Localizacion`, `id_sensor`, `id_usuario`, `id_habitacion`, `codigo_sensor`, `nombre_sensor`, `senact_sensor`, `tipo_sensor`, `modelo_sensor`, `descripcion_sensor`) VALUES
('', 0, NULL, NULL, NULL, 1, NULL, 15, 'J7542', 'Sensor1', 1, 'Luminosidad', 'TSL2561 ADAFRUIT', 'Sensor de luz para arduino'),
...
ALTER TABLE `sensor_usuario`
  ADD CONSTRAINT `sensorUs` FOREIGN KEY (`id_sensor`) REFERENCES `sensoractuador` (`id_sensor`) ON DELETE CASCADE ON UPDATE CASCADE,
