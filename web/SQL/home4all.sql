...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-08-2015 a las 17:37:10
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf16 AUTO_INCREMENT=200 ;
...
(179, '#c12e2a', '#cc2efa', 1, 12, 0, 4, 0, 0, 0, 'crom_full.css', 1),
(180, '#eb9316', '#cc2efa', 1, 12, 1, 2, 0, 0, 0, 'crom_full.css', 1),
(197, '#265a88', '#eb9316', 1, 12, 1, 2, 0, 0, 0, 'crom_full.css', 1),
(198, '#265a88', '#eb9316', 1, 12, 1, 2, 0, 0, 0, 'darkTheme.css', 0),
(199, '#265a88', '#eb9316', 1, 12, 0, 4, 0, 0, 0, 'lightTheme.css', 0);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf16 AUTO_INCREMENT=184 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf16 AUTO_INCREMENT=625 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf16 AUTO_INCREMENT=197 ;
