...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-04-2015 a las 20:17:47
...
(15, 'hab2', NULL, 'Dormitorio', NULL, 60, NULL),
...
(21, 'hab77', NULL, 'Dormitorio', NULL, 58, NULL);
...
INSERT INTO `sensor` (`id_sensor`, `id_usuario`, `id_habitacion`, `codigo_sensor`, `nombre_sensor`, `senact_sensor`, `tipo_sensor`, `modelo_sensor`, `descripcion_sensor`) VALUES
(1, NULL, 15, 'J7542', 'Sensor1', 1, 'Luminosidad', 'TSL2561 ADAFRUIT', 'Sensor de luz para arduino'),
(3, NULL, NULL, 'Jb5621', 'Actuador1', 0, 'motor', 'Motor DC v48', 'motor de persiana para arduino'),
(4, 0, 15, '234', 'sensor voz', 1, 'voz', 'v65453', 'sensor de voz para escuchar');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf16 AUTO_INCREMENT=65 ;
...
--
ALTER TABLE `sensor`
  ADD CONSTRAINT `sensorhab` FOREIGN KEY (`id_habitacion`) REFERENCES `habitacion` (`id_habitacion`) ON DELETE SET NULL ON UPDATE NO ACTION;
